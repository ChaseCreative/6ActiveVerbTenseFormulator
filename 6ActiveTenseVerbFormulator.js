...
class Verb {
  ...
  presActInf(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second;
    } else if (this.second.slice(-3,) == "rre"){
      return this.second;
  ...
  plImperative(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "te";
    } else if(this.second.slice(-3,) == "ire"){
  ...
  presFirstSing(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "o";
    } else if (this.second.slice(-3,) == "ire"){
      return this.second.slice(0,-3) + "iō";
    }
  }
  ...
  presSecondSing(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "s";
    } else if (this.second.slice(-3,) == "ire"){
  ...
  presThirdSing(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "t";
    } else if (this.second.slice(-3,) == "ire"){
      return this.second.slice(0,-3) + "it";
    }
  }
  ...
  presFirstPl(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "imus";
    } else if (this.second.slice(-3,) == "ire"){
  ...
  presSecondPl(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "tis";
    } else if (this.second.slice(-3,) == "ire"){
  ...
  presThirdPl(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "unt";
    } else if (this.second.slice(-3,) == "ire"){
...
//imperfect
  ...
  impFirstSing(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "ēbam";
    } else if (this.second.slice(-3,) == "ire"){
      return this.second.slice(0,-3) + "iēbam";
    }
  }
  ...
  impSecondSing(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "ēbas";
    } else if (this.second.slice(-3,) == "ire"){
      return this.second.slice(0,-3) + "iēbās";
    }
  }
  ...
  impThirdSing(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "ēbat";
    } else if (this.second.slice(-3,) == "ire"){
      return this.second.slice(0,-3) + "iēbat";
    }
  }
  ...
  impFirstPl(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "ēbamus";
    } else if (this.second.slice(-3,) == "ire"){
      return this.second.slice(0,-3) + "iēbāmus";
    }
  }
  ...
  impSecondPl(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "ēbatis";
    } else if (this.second.slice(-3,) == "ire"){
      return this.second.slice(0,-3) + "iēbātis";
    }
  }
  ...
  impThirdPl(){
    if (this.second.slice(-3,) == "are"){
      ...
      return this.second.slice(0,-2) + "ēbant";
    } else if (this.second.slice(-3,) == "ire"){
      return this.second.slice(0,-3) + "iēbant";
    }
  }
  ...
  //future tense
    ...
    futFirstSing(){
      ...
      return this.second.slice(0,-2) + "am";
      } else if (this.second.slice(-3,) == "ire"){
        return this.second.slice(0,-3) + "iam";
      }
    }
    ...
    futSecondSing(){
      ...
      return this.second.slice(0,-2) + "ēs";
      } else if (this.second.slice(-3,) == "ire"){
        return this.second.slice(0,-3) + "iēs";
      }
    }
    ...
    futThirdSing(){
      ...
      return this.second.slice(0,-2) + "et";
      } else if (this.second.slice(-3,) == "ire"){
        return this.second.slice(0,-3) + "iet";
      }
    }
    ...
    futFirstPl(){
      ...
      return this.second.slice(0,-2) + "ēmus";
    ...
    futSecondPl(){
      ...
      return this.second.slice(0,-2) + "ētis";
      } else if (this.second.slice(-3,) == "ire"){
        return this.second.slice(0,-3) + "iētis";
      }
    }
    ...
    futThirdPl(){
      ...
      return this.second.slice(0,-2) + "ent";
      } else if (this.second.slice(-3,) == "ire"){
        return this.second.slice(0,-3) + "ient";
      }
    }
...
var intro = "Please select a Latin verb from the below list:" + "<br>" + "lacrimo" + "&emsp;" + "comparo" + "&emsp;" + "observo" + "&emsp;" + "obscuro" + "<br>" + "commoveo" + "&emsp;" + "compleo" + "&emsp;" + "everto" + "&emsp;" + "affero" + "<br>" + "aufero" + "&emsp;" + "bibo" + "&emsp;" + "edo" + "&emsp;" + "coquo" + "<br>" + "scindo" + "&emsp;" + "irrumpo" + "&emsp;" + "opprimo" + "&emsp;" + "quaero" + "&emsp;" + "deicio" +"<br>" + "eicio" + "&emsp;" + "";
...
function userNounInput(){
  ...
  var wordList = [["lacrimo", "lacrimare", "lacrimavi","lacrimatus", "cry", "crying", "cried", "cried"],["comparo", "comparare", "comparavi","comparatus", "buy", "buying", "bought", "bought"],["obscuro", "obscurare", "obscuravi","obscuratus", "darken", "darkening", "darkened", "darkened"],["commoveo", "commovēre", "commovi","commotus", "move", "moving", "moved", "moved"],["compleo", "complēre", "complevi","completus", "fill", "filling", "filled", "filled"],["everto", "evertere", "everti","eversus", "overtun", "overturning", "overturned", "overturned"],["affero", "afferre", "attuli","allatus", "bring", "bringing in", "brought in", "brought in"],["aufero", "auferre", "abstuli","ablatus", "remove", "carrying away", "carried away", "carried away"],["bibo", "bibere", "bibi","bibitus", "drink", "drinking", "drank", "drunk"],["edo", "edere", "edi","esus", "eat", "eating", "ate", "eaten"],["coquo", "coquere", "coxi","coctus", "cook", "cooking", "cooked", "cooked"],["scindo", "scindere", "scidi","scissus", "cut", "cutting", "cut", "cut"],["irrumpo", "irrumpere", "irrupi","irruptus", "charge", "bursting in", "burst in", "burst in"],["opprimo", "opprimere", "oppressi","oppressus", "overwhelm", "overwhelming", "overwhelmed", "overwhelmed"],["quaero", "quarere", "quaesivi","quaesitus", "seek", "seeking", "sought", "sought"],["deicio", "deicere", "deieci","deiectus", "throw", "throwing down", "thrown down", "thrown down"],["eicio", "eicere", "eieci","eiectus", "throw", "throwing out", "thrown out", "thrown out"]];
